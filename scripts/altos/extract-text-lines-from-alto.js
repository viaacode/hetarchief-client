...
(function() {
  ...
  builder = __nccwpck_require__(958);

  defaults = (__nccwpck_require__(251).defaults);
...
(function() {
  ...
  events = __nccwpck_require__(820);

  bom = __nccwpck_require__(624);

  processors = __nccwpck_require__(236);
...
(function() {
  ...
  defaults = __nccwpck_require__(251);

  builder = __nccwpck_require__(337);

  parser = __nccwpck_require__(314);
...
(function() {
  ...
  NodeType = __nccwpck_require__(267);

  XMLNode = __nccwpck_require__(608);
...
(function() {
  ...
  XMLCharacterData = __nccwpck_require__(709);
...
(function() {
  ...
  XMLDOMErrorHandler = __nccwpck_require__(744);

  XMLDOMStringList = __nccwpck_require__(28);
...
(function() {
  ...
  isObject = (__nccwpck_require__(229).isObject);
...
(function() {
  ...
  XMLDTDAttList = __nccwpck_require__(15);

  XMLDTDEntity = __nccwpck_require__(53);

  XMLDTDElement = __nccwpck_require__(421);

  XMLDTDNotation = __nccwpck_require__(837);

  XMLNamedNodeMap = __nccwpck_require__(361);
...
(function() {
  ...
  isPlainObject = (__nccwpck_require__(229).isPlainObject);

  XMLDOMImplementation = __nccwpck_require__(310);

  XMLDOMConfiguration = __nccwpck_require__(465);

  XMLNode = __nccwpck_require__(608);

  NodeType = __nccwpck_require__(267);

  XMLStringifier = __nccwpck_require__(594);

  XMLStringWriter = __nccwpck_require__(913);
...
(function() {
  ...
  ref = __nccwpck_require__(229), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject, getValue = ref.getValue;

  NodeType = __nccwpck_require__(267);

  XMLDocument = __nccwpck_require__(730);

  XMLElement = __nccwpck_require__(437);

  XMLCData = __nccwpck_require__(333);

  XMLComment = __nccwpck_require__(407);

  XMLRaw = __nccwpck_require__(329);

  XMLText = __nccwpck_require__(318);

  XMLProcessingInstruction = __nccwpck_require__(939);

  XMLDeclaration = __nccwpck_require__(364);

  XMLDocType = __nccwpck_require__(801);
  ...
  XMLAttribute = __nccwpck_require__(376);

  XMLStringifier = __nccwpck_require__(594);

  XMLStringWriter = __nccwpck_require__(913);

  WriterState = __nccwpck_require__(766);
...
(function() {
  ...
  ref = __nccwpck_require__(229), isObject = ref.isObject, isFunction = ref.isFunction, getValue = ref.getValue;
...
(function() {
  ...
  ref1 = __nccwpck_require__(229), isObject = ref1.isObject, isFunction = ref1.isFunction, isEmpty = ref1.isEmpty, getValue = ref1.getValue;
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent1) {
      ...
      if (!XMLElement) {
        ...
        XMLText = __nccwpck_require__(318);
        XMLProcessingInstruction = __nccwpck_require__(939);
        XMLDummy = __nccwpck_require__(590);
        NodeType = __nccwpck_require__(267);
        XMLNodeList = __nccwpck_require__(768);
        XMLNamedNodeMap = __nccwpck_require__(361);
        DocumentPosition = __nccwpck_require__(839);
      }
    }
...
(function() {
  ...
  XMLWriterBase = __nccwpck_require__(752);
...
(function() {
  ...
  assign = (__nccwpck_require__(229).assign);
...
(function() {
  ...
  ref = __nccwpck_require__(229), assign = ref.assign, isFunction = ref.isFunction;

  XMLDOMImplementation = __nccwpck_require__(310);

  XMLDocument = __nccwpck_require__(730);

  XMLDocumentCB = __nccwpck_require__(356);

  XMLStringWriter = __nccwpck_require__(913);

  XMLStreamWriter = __nccwpck_require__(601);
...
function toArray(objectOrArray) {
    if (lodash_es_isArray(objectOrArray)) {
        return objectOrArray;
    }
    return [objectOrArray];
}
function extractTextLinesFromAlto(altoJson) {
    const altoVersion = altoJson.alto.$.xmlns;
    switch (altoVersion) {
        case 'http://www.loc.gov/standards/alto/ns-v2#': {
            // Alto v2
            const altoV2 = altoJson;
            const textLines = lodash_es_compact(toArray(altoV2.alto.Layout).flatMap((Layout) => {
                return toArray(Layout.Page).flatMap((page) => {
                    return toArray(page.PrintSpace).flatMap((printSpace) => {
                        return toArray(printSpace.TextBlock).flatMap((textBlock) => {
                            return toArray(textBlock.TextLine).flatMap((textLine) => {
                                return toArray(textLine.String).flatMap((altoString) => {
        ...
        default:
            console.error(new Error(`Unsupported Alto format: "${altoVersion}", Current support is v2 and v3`));
            return {
                description: {
                    fileName: undefined,
