...
export const SEARCH_PAGE_IE_OBJECT_TABS = (): TabProps[] => [
	...
	},
	{
		...
		ariaLabel: tText('modules/visitor-space/const/index___videos'),
	},
	{
		...
		ariaLabel: tText('modules/visitor-space/const/index___audio'),
	},
	{
		...
		ariaLabel: tText('modules/visitor-space/const/visitor-space-tabs___krant'),
	},
];
