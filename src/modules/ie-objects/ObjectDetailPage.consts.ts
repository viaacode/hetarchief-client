import { ImageInfo } from '@iiif-viewer/IiifViewer';

export const OPEN_SEA_DRAGON_POC = 'openseadragon';
export const OPEN_SEA_DRAGON_POC_OBJECT_ID =
	'5ecf24fda6b640f5bfbd16bce0c96e896a31d107fac2406ba7ddbd45dff97ae473ee8ab893844aac812e9941a374cc01';

export const OPEN_SEA_DRAGON_POC_IMAGE_INFOS: ImageInfo[] = [
	{
		imageUrl: 'https://assets-qas.hetarchief.be/hetarchief/BERT_TEST_IIIF_VIEWER/german.jpg',
		thumbnailUrl:
			'https://assets-qas.hetarchief.be/hetarchief/BERT_TEST_IIIF_VIEWER/german-thumbnail.jpg',
		width: 2418,
		height: 2418,
		altoUrl:
			'https://assets-qas.hetarchief.be/hetarchief/BERT_TEST_IIIF_VIEWER/german-ocr.json',
	},
	{
		imageUrl:
