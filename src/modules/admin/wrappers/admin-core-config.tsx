	...
	return {
		...
		icon: {
			...
			componentProps: {
				...
				image: { name: IconNamesLight.Image },
				file: { name: IconNamesLight.File },
				noAudio: { name: IconNamesLight.NoAudio },
				noVideo: { name: IconNamesLight.NoVideo },
				noImage: { name: IconNamesLight.NoImage },
				noFile: { name: IconNamesLight.NoFile },
				noNewspaper: { name: IconNamesLight.NoNewspaper },
				quotes: { name: IconNamesLight.Quotes },
